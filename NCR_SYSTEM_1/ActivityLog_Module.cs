...
namespace NCR_SYSTEM_1
{
    public partial class ActivityLog_Module : Form
    {
        ...
        private void ActivityLog_Module_Load(object sender, EventArgs e)
        {
            ...
            printer.Columns.Add("Area/Module");
            printer.Columns.Add("Action/Activity");
        ...
        public void printfilter()
        {
            ...
            else if (ActivityLog_Filter_popup.user != "" && ActivityLog_Filter_popup.module != "" && ActivityLog_Filter_popup.module != "All")
            {
                ...
                dv.RowFilter = "[Date]  >='" + date1 + "'AND [Date] <='" + date2 + "' " + " AND [Area/Module] LIKE '%" + module + "%'" + " AND [User] LIKE '%" + user + "%'";
            ...
            else if (ActivityLog_Filter_popup.user == "" && ActivityLog_Filter_popup.module != "" && ActivityLog_Filter_popup.module != "All")
            {
                ...
                dv.RowFilter = "[Date]  >='" + date1 + "'AND [Date] <='" + date2 + "' " + " AND [Area/Module] LIKE '%" + module + "%'";
